        ...
        <div class="hidden sm:flex items-start gap-4">
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2 mb-1">
              ...
              <span v-if="entry.category === 'activations'" class="text-[10px] px-1.5 py-0.5 rounded font-medium" :style="{ backgroundColor: 'var(--color-activations)', color: '#000000' }">Activations</span>
